...
import cn.wischool.wsapp.wischoolandroidapp.BannerManager;
import cn.wischool.wsapp.wischoolandroidapp.R;
import cn.wischool.wsapp.wischoolandroidapp.adapter.HomeRefreshAdapter;
import cn.wischool.wsapp.wischoolandroidapp.com.zxing.android.CaptureActivity;
import cn.wischool.wsapp.wischoolandroidapp.common.UiHelper;
import cn.wischool.wsapp.wischoolandroidapp.infobean.Banner;
...
import cn.wischool.wsapp.wischoolandroidapp.ui.TaskSearchActivity;
import cn.wischool.wsapp.wischoolandroidapp.widget.VerticalTextView;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editImg = (ImageView) view.findViewById(R.id.home_edit_img);
...
//        });
        ...
        editImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(v.getContext(),PublishActivity.class));
            }
        });
